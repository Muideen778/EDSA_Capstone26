        ...
        <div class="d-flex justify-content-center align-items-center flex-column min-vh-lg-100">
          ...
          <header id="header" class="navbar navbar-height navbar-light mb-3">
            <div class="container">
              ...
              <img src="assets/img/500x650/logo.jpg" width="70px" height="70px" alt="" style="border: 1px solid black; border-radius: 50px;"><span style="font-size: 25px; font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; font-weight: 300;">Ekiti Learning Hub.</span>
              </a>
            </div>
          </header>
          <!-- ========== END HEADER ========== -->
