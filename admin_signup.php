                  ...
                  <div class="card-body">
                    ...
                    <form class="js-validate needs-validation" action=""  method="POST">
                      <div class="text-center">
                        <div class="mb-5">
                          <h3 class="card-title">Admin Signup Page</h3>
                      ...
                      <!-- End Form -->
                       ...
                       <!-- Form -->
                       <div class="mb-4">
                        <label class="form-label" for="fullnameSrEmail">Username</label>
                        <input type="text" class="form-control form-control-lg" name="username" id="signupSrEmail" placeholder="Muhideen778" aria-label="" required>
                      ...
                      <div class="mb-4">
                        ...
                        <input type="email" class="form-control form-control-lg" name="email" id="" placeholder="example@site.com" aria-label="" required>
                      ...
                      <div class="mb-4">
                        ...
                        <div class="input-group-merge">
                          <input type="password" class="js-toggle-password form-control form-control-lg" name="hash" id="" placeholder="8+ characters required" aria-label="8+ characters required" required minlength="8" data-hs-toggle-password-options='{
                      ...
                      <div class="mb-4">
                        ...
                        <div class="input-group-merge">
                          <input type="password" class="js-toggle-password form-control form-control-lg" name="confirm" id="signupSrConfirmPassword" placeholder="8+ characters required" aria-label="8+ characters required" required minlength="8" data-hs-toggle-password-options='{
                                   "target": [".js-toggle-password-target-1", ".js-toggle-password-target-2"],
                                   "defaultClass": "bi-eye-slash",
                                   "showClass": "bi-eye",
                      ...
                      <div class="d-grid gap-4">
                        ...
                        <p class="card-text text-muted">Remember your password? <a class="link" href="admin_login.php">Log in</a></p>
                      </div>
                    </form>
                    <!-- End Form -->
                  </div>
