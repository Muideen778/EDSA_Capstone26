...
?>
                      ...
                      <div class="mb-4">
                        ...
                        <div class="input-group-merge">
                          <input type="password" class="js-toggle-password form-control form-control-lg" name="hash" id="signupSrPassword" placeholder="8+ characters required" aria-label="8+ characters required" required minlength="8" data-hs-toggle-password-options='{
                      ...
                      <div class="d-grid gap-4">
                        ...
                        <p class="card-text text-muted">Don't have an account yet? <a class="link" href="admin_signup.php">Sign up here</a></p>
                      </div>
                    </form>
                    <!-- End Form -->
                  </div>
