        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <div class="navbar-absolute-top-scroller">
            <ul class="navbar-nav nav-pills">
              ...
              <a class="btn btn-ghost-dark me-2 me-lg-0" href="page-login.php">Log in</a>
                <a class="btn btn-dark d-lg-none" href="page-signup.php">Sign up</a>
              </li>
              <!-- End Log in -->
              ...
              <li class="nav-item">
                ...
                <a class="btn btn-dark d-none d-lg-inline-block" href="page-signup.php">Sign up</a>
              </li>
              <!-- End Sign up -->
            </ul>
          </div>
