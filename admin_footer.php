      ...
      <div class="container">
        <div class="row align-items-center pt-8 pb-4">
          <div class="col-md mb-5 mb-md-0">
            <h2 class="fw-medium text-white-70 mb-0">Join the thriving<br><span class="fw-bold text-white">Ekiti</span> Learning Hub</h2>
          </div>
          <!-- End Col -->
        ...
        <div class="border-bottom border-white-10">
          ...
          <div class="col-6 col-sm-4 col-lg">
            ...
            <div class="col-6 col-sm-4 col-lg mb-7 mb-sm-0">
              ...
              <!-- List -->
              <ul class="list-unstyled list-py-1 mb-0">
                <li><a class="link link-light link-light-75" href="#">Science</a></li>
                <li><a class="link link-light link-light-75" href="#">Art</a></li>
                <li><a class="link link-light link-light-75" href="#">Commercial</a></li>
                <li><a class="link link-light link-light-75" href="#">IT tracts</a></li>
              </ul>
              <!-- End List -->
            </div>
            <!-- End Col -->
            ...
            <div class="col-6 col-sm-4 col-lg mb-7 mb-lg-0">
              <span class="text-cap text-white">Details</span>
  
              <!-- List -->
              <ul class="list-unstyled list-py-1 mb-0">
                <li><a class="link link-light link-light-75" href="#">Belonging <i class="bi-box-arrow-up-right ms-1"></i></a></li>
                <li><a class="link link-light link-light-75" href="#">Profile</a></li>
            ...
            <div class="col-6 col-sm-4 col-lg mb-7 mb-sm-0">
              ...
              <ul class="list-unstyled list-py-1 mb-5">
                <li><a class="link link-light link-light-75" href="page-terms.php">Terms of use</a></li>
                <li><a class="link link-light link-light-75" href="page-privacy.php">Privacy policy <i class="bi-box-arrow-up-right ms-1"></i></a></li>
              </ul>
              <!-- End List -->
            </div>
            <!-- End Col -->
        ...
        <div class="row align-items-md-center py-6">
          <div class="col-md mb-3 mb-md-0">
            ...
            <ul class="list-inline list-px-2 mb-0">
              <li class="list-inline-item"><a class="link link-light link-light-75" href="page-privacy.php">Privacy and Policy</a></li>
              <li class="list-inline-item"><a class="link link-light link-light-75" href="page-terms.php">Terms</a></li>
